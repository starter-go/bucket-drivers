...
func (inst *CaseTryCRUD) ListRegistrations(list []*units.Registration) []*units.Registration {
...
func (inst *CaseTryCRUD) _impl() units.Unit {
	return inst
}

func (inst *CaseTryCRUD) run(cc context.Context) error {
